...
init_range_x = [-2.5, 2.5];
init_range_y = [-2.5, 2.5];
% Range of the termination of the simulation in case the trajectory
% diverges.
terminate_range_x = [-2.5, 2.5];
...
% save_figure(fig, 'file_name', 'buckling_beam_phase_portrait', 'file_format', 'pdf', 'figure_size', [4 3]);
